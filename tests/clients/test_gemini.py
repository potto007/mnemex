...
class TestGeminiClientUnit:
    ...
    def test_init_with_api_key(self):
        ...
        with patch("lm_repl.clients.gemini.genai.Client"):
    ...
    def test_init_requires_api_key(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            with patch("lm_repl.clients.gemini.DEFAULT_GEMINI_API_KEY", None):
    ...
    def test_completion_with_mocked_response(self):
        ...
        with patch("lm_repl.clients.gemini.genai.Client") as mock_client_class:
